...
public class Destination implements Serializable {
  ...
  public static Destination newFromRun(Run run, S3Artifact artifact, String defaultBucketName)
  {
    return newFromRun(run, artifact.getBucket(defaultBucketName), artifact.getName(), artifact.useFullProjectName());
  }
}
