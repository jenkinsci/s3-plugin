    ...
    public boolean perform(AbstractBuild<?, ?> build,
        ...
        try {
            ...
            for (Entry entry : entries) {
                ...
                List<InvalidationRecord> invalidationRecord = Lists.newArrayList();
                ...
                invalidationRecord.add(profile.invalidate(build, listener, bucket, searchPathLength, entry.invalidateAfterUpload, paths));
